...
public final class Config {
    public static final class Debug {
        ...
        public String toString() {
            return "Debug{" + "printMapString=" + printMapString + ", printTStrings=" + printTStrings
                    + ", printActStrings=" + printActStrings + ", printHitStrings=" + printHitStrings
                    + ", printPlayerInputStrings=" + printPlayerInputStrings + ", printBotErrors=" + printBotErrors
    ...
    public static final class UnitInformation implements UnitInformationDisplay, RealUnitInformation {
        ...
        // there are missing variables like selfDestructRange that shouldn't be needed
        // for most strategies and leave you to add.
        ...
        @Override
        public String toString() {
            return "UnitInformation{" + "icon='" + icon + "''" + "iconxScale=" + iconxScale + "iconyScale=" + iconyScale
                    + "display='" + display + "'" + "shorthand='" + shorthand + "'" + "attackDamageTower="
                    + attackDamageTower + "attackDamageWalker=" + attackDamageWalker + "attackRange=" + attackRange
                    + "getHitRadius=" + getHitRadius + "unitCategory=" + unitCategory + "shieldPerUnit=" + shieldPerUnit
                    + "shieldRange=" + shieldRange + "shieldBonusPerY=" + shieldBonusPerY + "shieldDecay=" + shieldDecay
                    + "startHealth=" + startHealth + "speed=" + speed + "cost1=" + cost1 + "cost2=" + cost2
                    + "upgrade=\n" + upgrade + '}';
        }

        /**
         * This function should only be called by Unit.java Because this should never be
         * called on the unit information in the config directly but on an instance copy
         * of this in a unit. Otherwise you will modify the default values of a unit.
         */
        public void upgrade() {
            if (upgrade.get() != null) {
                ...
                upgrade.get().attackDamageWalker
                        .ifPresent(newVal -> this.attackDamageWalker = OptionalDouble.of(newVal));
                ...
                upgrade.get().cost1.ifPresent(newVal -> this.cost1 = OptionalDouble
                        .of(newVal + (this.cost1.isPresent() ? this.cost1.getAsDouble() : 0)));
                upgrade.get().cost2.ifPresent(newVal -> this.cost2 = OptionalDouble
                        .of(newVal + (this.cost2.isPresent() ? this.cost2.getAsDouble() : 0)));
    ...
    public static final class Resources {
        ...
        @Override
        public String toString() {
            return "Resources{" + "turnIntervalForBitCapSchedule=" + turnIntervalForBitCapSchedule
                    + ", turnIntervalForBitSchedule=" + turnIntervalForBitSchedule + ", bitRampBitCapGrowthRate="
                    + bitRampBitCapGrowthRate + ", roundStartBitRamp=" + roundStartBitRamp + ", bitGrowthRate="
                    + bitGrowthRate + ", startingHP=" + startingHP + ", maxBits=" + maxBits + ", bitsPerRound="
                    + bitsPerRound + ", coresPerRound=" + coresPerRound + ", coresForPlayerDamage="
                    + coresForPlayerDamage + ", startingBits=" + startingBits + ", bitDecayPerRound=" + bitDecayPerRound
    ...
    public static final class Mechanics {
        ...
        @Override
        public String toString() {
            return "Mechanics{" + "basePlayerHealthDamage=" + basePlayerHealthDamage + ", damageGrowthBasedOnY="
                    + damageGrowthBasedOnY + ", bitsCanStackOnDeployment=" + bitsCanStackOnDeployment
                    + ", destroyOwnUnitRefund=" + destroyOwnUnitRefund + ", destroyOwnUnitsEnabled="
                    + destroyOwnUnitsEnabled + ", stepsRequiredSelfDestruct=" + stepsRequiredSelfDestruct
                    + ", selfDestructRadius=" + selfDestructRadius + ", shieldDecayPerFrame=" + shieldDecayPerFrame
                    + ", meleeMultiplier=" + meleeMultiplier + ", destroyOwnUnitDelay=" + destroyOwnUnitDelay
                    + ", rerouteMidRound=" + rerouteMidRound + ", structureBuildTime=" + structureBuildTime + '}';
        }
    }
    ...
    private static final class OptionalDoubleDeserializer implements JsonDeserializer<OptionalDouble> {
        @Override
        public OptionalDouble deserialize(JsonElement jsonElement, Type type,
    ...
    private static final class OptionalIntDeserializer implements JsonDeserializer<OptionalInt> {
        @Override
        public OptionalInt deserialize(JsonElement jsonElement, Type type,
                JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
            try {
                try {
    ...
    static {
        GSON = new GsonBuilder().registerTypeAdapter(OptionalDouble.class, new OptionalDoubleDeserializer())
                .registerTypeAdapter(OptionalInt.class, new OptionalIntDeserializer())
                .registerTypeAdapter(Optional.class, new OptionalDeserializer()).create();
    }

    @Override
    public String toString() {
        return "Config{" + "debug=" + debug + ", unitInformation=" + unitInformation + ", resources=" + resources
                + ", mechanics=" + mechanics + '}';
    }
}
